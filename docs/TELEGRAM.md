...
#### **бот / цитирование / @упоминание** (быстрый ответ)
```
Пользователь: Что думает бот о нашем споре?
Чатумба: 🤖 [быстрый анализ последних сообщений]

Пользователь: @IKAR_IKARYCH_BOT спой песню
Чатумба: 🎵 [корректная реакция с учетом исходного текста]
```
...
### **Защита от спама:**
- **Cooldown**: отключён для основных триггеров (мгновенная реакция)
