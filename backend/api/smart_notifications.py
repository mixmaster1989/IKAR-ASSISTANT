...
class SmartNotifications:
    ...
    async def send_thinking_notification(self, chat_id: str, process_type: str = "thinking") -> Optional[str]:
        ...
        try:
            ...
            # Отправляем уведомление с Markdown форматированием
            message_id = await send_telegram_message(chat_id, message, parse_mode="MarkdownV2")
    ...
    async def update_notification(self, chat_id: str, new_message: str) -> bool:
        ...
        try:
            ...
            success = await edit_telegram_message(chat_id, message_id, new_message, parse_mode="MarkdownV2")
    ...
    async def complete_notification(self, chat_id: str, final_message: str = "✅ *Готово!*") -> bool:
        ...
        try:
            ...
            success = await edit_telegram_message(chat_id, message_id, final_message, parse_mode="MarkdownV2")
