#!/usr/bin/env python3
"""
Тест модели deepseek/deepseek-chat-v3.1:free с твоим ключом
"""
...
async def test_deepseek_v3():
    """Тестирует модель deepseek/deepseek-chat-v3.1:free"""
    ...
    print(f"🔍 ТЕСТ МОДЕЛИ deepseek/deepseek-chat-v3.1:free")
    print("=" * 50)
...
if __name__ == "__main__":
    result = asyncio.run(test_deepseek_v3())
    if result:
        print("\n🎉 МОДЕЛЬ deepseek/deepseek-chat-v3.1:free РАБОТАЕТ!")
    else:
        print("\n💥 МОДЕЛЬ НЕ РАБОТАЕТ!")
